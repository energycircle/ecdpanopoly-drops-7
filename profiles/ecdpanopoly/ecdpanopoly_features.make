...
projects[ec_administrative_dashboard][version] = 1.x
...
projects[ec_base_content][version] = 1.x
...
projects[ec_blog_post][version] = 1.x
...
projects[ec_campaign_page][version] = 1.x
...
projects[ec_casestudy][version] = 1.x
...
projects[ec_development][version] = 1.x
...
projects[ec_distinction][version] = 1.x
...
projects[ec_external_video][type] = module
projects[ec_external_video][version] = 1.x
...
projects[ec_financing_option][version] = 1.x
...
projects[ec_foundation_image_styles][version] = 1.x
...
projects[ec_panopoly_page_overrides][version] = 1.x
...
projects[ec_product_page_category][version] = 1.x
